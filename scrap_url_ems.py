#!/usr/bin/python3
# -*- coding: utf-8 -*-
# Essai de récupération des urls de descrition des EMS sur https://www.heviva.ch/institutions.html

version = "0.1.1 zf200408.1253"

print("scrap_url_ems.py ver " + version)
